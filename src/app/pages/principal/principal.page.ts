...
export class PrincipalPage implements OnInit {
  articulosCarro = 0;
  sliderImagesMarcas = [
    '/assets/marcas/Audi.jpg',
    '/assets/marcas/BMW.jpg',
    '/assets/marcas/chevrolet.jpg',
    '/assets/marcas/chrysler.jpg',
    '/assets/marcas/dodge.jpg',
    '/assets/marcas/fiat.jpg',
    '/assets/marcas/ford.jpg',
    '/assets/marcas/gmc.jpg',
    '/assets/marcas/honda.jpg',
    '/assets/marcas/hyundai.jpg',
    '/assets/marcas/jeep.jpg',
    '/assets/marcas/kia.jpg',
    '/assets/marcas/lincoln.jpg',
    '/assets/marcas/mazda.jpg',
    '/assets/marcas/mercedes.jpg',
    '/assets/marcas/mitsubichi.jpg',
    '/assets/marcas/nissan.jpg',
    '/assets/marcas/peugeot.jpg',
    '/assets/marcas/pontiac.jpg',
    '/assets/marcas/renault.jpg',
    '/assets/marcas/seat.jpg',
    '/assets/marcas/suzuki.jpg',
    '/assets/marcas/toyota.jpg',
    '/assets/marcas/VOLKSWAGEN.jpg',
  ];
  sliderImages = [
  ...
  async ngOnInit() {
    ...
    this.productService.getProducts().subscribe(async (prodducts: ProductModel[]) => {
